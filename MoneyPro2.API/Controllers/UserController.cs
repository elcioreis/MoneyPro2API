...
public class UserController : ControllerBase
{
    ...
    )
    {
        ...
        catch (DbUpdateException ex)
        {
            if (
                ...
                return StatusCode(
                    ...
                    new ResultViewModel<string>(
                        $"01x01 - O usuário '{user.Username}' já está em uso"
                    )
                );
            ...
            return StatusCode(
                500,
                new ResultViewModel<string>("01x04 - Erro ao cadastrar o usuário")
            );
        }
        catch
        {
            return StatusCode(
                500,
                new ResultViewModel<string>("01x05 - Falha interna no servidor")
            );
        }
    }
